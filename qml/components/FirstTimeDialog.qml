/*
    Thi/ file is part of shiftwallet.
...
Window {
    ...
    Column {
        ...
        Text {
            ...
            text: qsTr("Please confirm options for Gshift before running for the first time")
        }
        ...
        Text {
            ...
            font.bold: true
            wrapMode: Text.WrapAtWordBoundaryOrAnywhere
            text: qsTr("Shift blockchain grows rapidly and requires at least 20GB of space. Make sure to choose an appropriate data directory with enough space left.")
        }
